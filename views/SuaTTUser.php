    ...
    <header class="header">
        <div class="grid header__1">
            <div class="header__logo">
                ...
                <h3 class="header__span">SỬA THÔNG TIN TÀI KHOẢN CỦA BẠN</h3>
            </div>
    ...
    <div class="content">
        <div class="auth-form"> 
            <div class="auth-form__container">
                ...
                <form action="?task=update_usert" method="POST" enctype="multipart/form-data">
                    <div class="auth-form__form">
                        <div class="auth-form__group">
                            <input type="text" value = "<?php echo $data['id_user']?>" class="auth-form__inputid"  name = "id_user" placeholder="ID của bạn">
                        </div>
                        <div class="auth-form__group">
                            <input type="text"  value = "<?php echo $data['hoten']?>"class="auth-form__input" name = "hoten" placeholder="Họ tên của bạn">
                        </div>
                        <div class="auth-form__group">
                            <input type="date" value = "<?php echo $data['ngaysinh']?>" class="auth-form__input"  name = "ngaysinh" placeholder="Ngày sinh ">
                        </div>
                        <div class="auth-form__group">
                            <input type="text" value = "<?php echo $data['quequan']?>" class="auth-form__input"  name = "quequan" placeholder="Quê quán">
                        </div>
                        <div class="auth-form__group">
                            <input type="text" value = "<?php echo $data['email']?>" class="auth-form__input"  name = "email" placeholder="Email của bạn">
                        </div>
                        <div class="auth-form__group">
                            <input type="password" value = "<?php echo $data['matkhau']?>" class="auth-form__input"  name = "matkhau" placeholder="Mật khẩu ">
                        </div>
                        <div class="auth-form__group">
                            <input type="text" value = "<?php echo $data['sdt']?>" class="auth-form__input"  name = "sdt" placeholder="So Dien Thoai ">
                        </div>
                       
                        <div class="auth-form__group">
                            <input type="file" class="auth-form__input"  name = "photo" placeholder="anh "><img class="input__img" src="<?php echo $data['photo']?>" alt="">
                        </div>
                    </div>
                    <div class="auth-form__controls">
                        <a href="./Dangnhap/Dangnhap.html">
                            <input type="submit" class="btn" value="Sửa Thông Tin Phòng"></input>
                        </a>
                    </div>
                </form>
            </div>
